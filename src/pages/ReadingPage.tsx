      ...
      <div className="bg-background border-b border-border">
        <div className="container mx-auto px-4 py-3">
          <p className="text-sm text-muted-foreground">
            <span className="font-medium text-foreground">Tip:</span> Use official IELTS/OET reading passages for best results.
          </p>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6 max-w-7xl mx-auto">
          ...
          <Card className="p-6">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-foreground">Reading Assistant</h2>
                <p className="text-sm text-primary font-medium">Comprehension Coach</p>
              </div>
            </div>
          ...
          <Card className="p-6">
            ...
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-muted-foreground text-center">
                Submit a passage to see AI feedback
              </p>
            </div>
          </Card>
        </div>
