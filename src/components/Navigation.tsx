...
import { ChevronDown, Menu, X, Search, Instagram, MessageCircle, Youtube, MessageSquare } from "lucide-react";
    ...
    <nav className="bg-background border-b border-border sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          {/* Logo */}
          <Link to="/" className="flex items-center space-x-3 group" aria-label="NextDoc Global home">
            <img 
            ...
            <div className="hidden md:flex flex-col leading-tight">
              <span className="text-lg font-semibold text-foreground">NextDoc Global</span>
            ...
            <div className="md:hidden flex flex-col leading-tight">
              <span className="text-sm font-semibold text-foreground">NextDoc</span>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-background border border-border shadow-lg z-50">
                <DropdownMenuItem asChild>
                  <Link to="/exams/ielts-oet" className="w-full cursor-pointer">
                    IELTS/OET
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
          ...
          <div className="md:hidden py-4 border-t border-border bg-background">
            <div className="flex flex-col space-y-4">
              <div className="flex items-center space-x-3 pb-3 border-b border-border">
                <img src="/lovable-uploads/3c8598c8-d4bf-45d9-aecf-8cbd962854bc.png" alt="NextDoc Global logo" className="h-10 w-auto" />
                <div className="flex flex-col leading-tight">
                  <span className="text-base font-semibold text-foreground">NextDoc Global</span>
                  <span className="text-xs text-primary font-medium">AI Powered</span>
                </div>
              </div>
              <Link 
              ...
              <div className="space-y-2">
                <p className="text-muted-foreground text-sm font-medium py-1">Exams</p>
              ...
              <div className="pt-3 border-t border-border">
                <p className="text-muted-foreground text-sm font-medium mb-3">Connect</p>
