        ...
        <div className="py-6 md:py-12 grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <img 
                src="/lovable-uploads/3537f026-e960-40eb-8bb3-9aa52d2dab09.png" 
                alt="NextDoc Global Logo" 
                className="w-8 h-8"
              />
              <div className="flex flex-col">
                <span className="text-lg font-bold text-primary">NextDoc Global</span>
                <span className="text-xs text-muted-foreground">Built by Doctors, For Doctors. AI Powered</span>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <Link to="/exams/ielts-oet" className="block text-muted-foreground hover:text-primary transition-colors">
                IELTS/OET
              </Link>
